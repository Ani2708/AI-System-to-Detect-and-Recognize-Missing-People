...
VIDEO_1 = "lowlight1.mp4"
VIDEO_2 = "lowlight2.mp4"
VIDEO_3 = "lowlight3.mp4"
...
while True:
    ...
    if frame_count % FRAME_SKIP == 0:
        ...
        if ret3:
            frame3 = recognize_frame(frame3, "CAM 3")
            last_frame3 = frame3.copy()
        ...
        if last_frame3 is not None and ret3:
            frame3 = last_frame3.copy()
